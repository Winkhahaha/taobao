const lyTop = {
            ...
            <div class='py-container'> \
                <div class='yui3-g Logo'> \
                    <div class='yui3-u Left logoArea'> \
                        <a class='logo-bd' title='淘宝'  @click='gotoIndex' href='javascript:void(0)' target='_blank'></a> \
                    </div> \
    ...
    methods: {
        ...
        gotoIndex(){
            window.location = "http://www.taobao.com/index.html";
        },
        gotoSeckill(){
            window.location = "http://www.taobao.com/seckill-index.html";
        },
        gotoCart(){
            window.location = "http://www.taobao.com/cart.html";
        }
    },
    created() {
